...
class FlutterMarquee extends StatefulWidget {
  ...
  FlutterMarquee(
      ...
      : assert(children != null || texts != null),
        ...
        this.seletedTextColor = seletedTextColor ?? Color(0xFFCCCCCC),
...
class _FlutterMarquee extends State<FlutterMarquee> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.animateDistance == null) {
      if (widget.animationDirection == AnimationDirection.l2r || widget.animationDirection == AnimationDirection.l2r) {
